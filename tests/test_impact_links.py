...
class ImpactManualWalmartLinkTestCase(unittest.TestCase):
    ...
    def test_generate_walmart_link_uses_required_creator_goto_without_api(self):
        ...
        self.assertEqual(query["u"], ["https://www.walmart.com/ip/5454929532?utm_source=echo"])
        self.assertEqual(query["subId1"], ["chat-recommendation"])
        self.assertEqual(query["subId2"], ["5454929532"])
        self.assertEqual(query["subId3"], ["creator-feed"])
