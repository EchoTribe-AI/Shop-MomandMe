...
# Campaign Builder v3 surface removed in the Shop-MomandMe strip-down
# (2026-05-17). All nine /archer/campaigns* routes (page, list,
# get-by-id, patch, delete, export, generate, boost, fetch-product)
# were EchoTribe-internal ad-ops. campaign_builder.py is also deleted
# in the same commit — git grep showed only three call sites inside
# the deleted routes.
#
# /archer/track_click (public storefront click logger) sits in this
