...
class ImpactAPI:
    ...
    def generate_walmart_link(self, product_url: str, product_id: str = None, 
        ...
        """Build the required Walmart creator-path goto affiliate link."""
        return self.generate_walmart_creator_goto_link(product_url, product_id, sub_id1, sub_id2, sub_id3)

    def generate_walmart_creator_goto_link(self, product_url: str, product_id: str = None,
                                           sub_id1: str = "chat", sub_id2: str = None,
                                           sub_id3: str = None) -> str:
        """Build the required Walmart creator-path goto affiliate link."""
    ...
    def _build_manual_link(self, product_url: str, product_id: str, 
        ...
        """Build the Walmart creator-path goto link with a single-encoded clean destination.

        ``urlencode`` performs the final single encoding for query parameter
        values after the Walmart destination is normalized, unwrapped, and
        cleaned.
        """
        base = (
    ...
    def _normalize_walmart_destination_url(cls, product_url: str) -> str:
        ...
        The creator-path goto builder applies query encoding later. This method
        accepts raw or already-encoded Walmart destinations, unwraps any existing
