...
def bootstrap() -> None:
    ...
    Fresh PostgreSQL launch intentionally creates schema and the default
    creator only. Historical SQLite data must be migrated or re-imported
    explicitly; app startup must never auto-seed from data/archer_catalog.db.
    """
    init_schema()
    seed_default_creator()
